    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                ...
                elif isinstance(self.ant, QueenAnt) == True and self.ant.is_impostor == False:
                	self.ant = self.ant
                else:
                    self.ant = None 
            else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        # BEGIN Problem 3B
        "*** REPLACE THIS LINE ***"
        current_place, num_transitions = self.place, 0
        if current_place.bees and num_transitions in range(self.min_range, self.max_range + 1):
            return random_or_none(current_place.bees)
        while current_place.entrance and current_place.entrance != hive:
            num_transitions += 1
            if current_place.entrance.bees and num_transitions in range(self.min_range, self.max_range + 1):
                return random_or_none(current_place.entrance.bees)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    food_cost = 7
    is_impostor = False
    """Does not work, calling impostor after queen still outputs 1"""
    is_initiated = False
    # END Problem 9
    ...
    def __init__(self):
        ...
        "*** REPLACE THIS LINE ***"
        self.armor = 1
        if QueenAnt.is_initiated:
            self.is_impostor = True
        else:
        	QueenAnt.is_initiated = True
        # END Problem 9
    ...
    def action(self, colony):
        ...
        if self.is_impostor:
            ...
            while current_place.exit:
                if current_place.ant and current_place.ant not in double_damaged_ants:
                    if current_place.ant.container:
                        current_place.ant.ant.damage *= 2
                    else:
                        current_place.ant.damage *= 2
                    double_damaged_ants.append(current_place.ant)
